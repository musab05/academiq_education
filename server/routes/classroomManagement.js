...
// Allow students to create classrooms (they'll be auto-promoted to instructor)
router.post("/", authenticate, canCreate("classroom"), createClassroom);
...
router.delete(
  "/:classroomId/unenroll/:studentId",
  authenticate,
  unenrollStudent,
);
router.post("/:classroomId/enroll-team", authenticate, enrollTeam);
router.delete(
  "/:classroomId/unenroll-team/:teamId",
  authenticate,
  unenrollTeam,
);
