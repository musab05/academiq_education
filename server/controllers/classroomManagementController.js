...
export const createClassroom = async (req, res) => {
  try {
    ...
    // Auto-promote student to instructor when they create a classroom
  ...
  try {
    ...
    const canEdit =
      ...
      (currentUser.role === "admin" &&
        classroom.institute?.toString() === currentUser.institute?.toString());
    ...
    if (maxParticipants !== undefined)
      classroom.maxParticipants = maxParticipants;
    if (isPrivate !== undefined) classroom.isPrivate = isPrivate;
    if (autoEnrollInstituteStudents !== undefined)
      classroom.autoEnrollInstituteStudents = autoEnrollInstituteStudents;
