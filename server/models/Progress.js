...
const progressSchema = new mongoose.Schema(
  {
    ...
    lesson: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "Lesson",
      required: false, // Not required for course-level progress records
    },
    chapter: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "Chapter",
...
// Sparse partial index for lesson-level progress (when lesson exists)
progressSchema.index(
  { user: 1, course: 1, lesson: 1 },
  { unique: true, partialFilterExpression: { lesson: { $exists: true } } },
);
// Index for course-level progress queries
