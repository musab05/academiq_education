  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <ProtectedRoute
            allowedRoles={["admin", "superadmin", "instructor", "student"]}
          >
            <ProfilePage />
          </ProtectedRoute>
        }
      ...
      />
      <Route
        path="/course-overview/:slug/settings/general"
        element={
          <ProtectedRoute>
            <GeneralSettingsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/settings/access"
        element={
          <ProtectedRoute>
            <AccessSettingsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/settings/completion"
        element={
          <ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/settings/certificate"
        element={
          <ProtectedRoute>
            <CourseSettingsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/settings/notifications"
        element={
          <ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/settings/grading"
        element={
          <ProtectedRoute>
            <GradingSettingsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/settings/advanced"
        element={
          <ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/resources"
        element={
          <ProtectedRoute>
            <CourseResourcesPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/enrollments/users"
        element={
          <ProtectedRoute>
            <UserEnrollmentsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/enrollments/teams"
        element={
          <ProtectedRoute>
            <TeamEnrollmentsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/reports/users"
        element={
          <ProtectedRoute>
            <UserReportsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/reports/users/:userId"
        element={
          <ProtectedRoute>
            <UserDetailReportPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/course-overview/:slug/reports/teams"
        element={
          <ProtectedRoute>
            <TeamReportsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/reports/teams/:teamId"
        element={
          <ProtectedRoute>
            <TeamDetailReportPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/course-overview/:slug/reports/course"
        element={
          <ProtectedRoute>
            <CourseReportsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/reports/lesson/:lessonId"
        element={
          <ProtectedRoute>
            <LessonDetailReportPage />
          </ProtectedRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/institutes/:id/analytics"
        element={
          <ProtectedRoute allowedRoles={["admin", "superadmin"]}>
            <InstituteAnalyticsPage />
          </ProtectedRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/classroom-preview/:classroomId"
        element={
          <ProtectedRoute>
            <ClassroomPreviewPage />
          </ProtectedRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/classroom/:classroomId/session/:sessionId"
        element={
          <ProtectedRoute>
            <StudentSessionPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/classroom/:classroomId/enrollments/students"
        element={
          <ProtectedRoute>
            <ClassroomEnrollmentsPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/classroom/:classroomId/enrollments/teams"
        element={
          <ProtectedRoute>
            <ClassroomTeamEnrollmentsPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/classroom/:classroomId/reports/attendance"
        element={
          <ProtectedRoute>
            <ClassroomAttendanceReportPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/classroom/:classroomId/session/:sessionId/attendance"
        element={
          <ProtectedRoute>
      ...
      />
      <Route
        path="/classroom/:classroomId/reports/engagement"
        element={
          <ProtectedRoute>
            <ClassroomEngagementReportPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/classroom/:classroomId/recordings"
        element={
          <ProtectedRoute>
            <ClassroomRecordingsPage />
          </ProtectedRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/classrooms/:sessionId/live"
        element={
          <ProtectedRoute>
            <LiveClassroom />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/assignment-lesson/:lessonId/submissions"
        element={
          <ProtectedRoute>
      ...
      <Route
        path="/course-overview/:slug/assignments"
        element={
          <ProtectedRoute allowedRoles={["admin", "superadmin", "instructor"]}>
            <AssignmentsListPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/course-overview/:slug/assignment/:lessonId/grade"
        element={
          <ProtectedRoute allowedRoles={["admin", "superadmin", "instructor"]}>
      ...
      />
      <Route
        path="/assignment-lesson/:lessonId"
        element={
          <ProtectedRoute>
