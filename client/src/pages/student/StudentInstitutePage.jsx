...
import { Building2, Users, BookOpen, Mail, Phone, MapPin } from 'lucide-react';
        ...
        <div className="flex-1 overflow-auto p-4 sm:p-6 md:p-8">
          <div className="max-w-5xl mx-auto">
            <div className="mb-6 sm:mb-8">
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">My Institute</h1>
              <p className="text-sm sm:text-base text-gray-600">Information about your educational institution</p>
            </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-12 sm:py-16 bg-white rounded-xl">
                ...
                <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-2">No Institute Assigned</h3>
                <p className="text-sm sm:text-base text-gray-500">You are not associated with any institute</p>
              </div>
            ) : (
                ...
                <div className="bg-gradient-to-r from-orange-500 to-red-500 p-4 sm:p-6 md:p-8 text-white">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="min-w-0">
                      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold truncate">{institute.name}</h2>
                      {institute.domain && (
                        <p className="text-orange-100 mt-1 text-sm sm:text-base truncate">{institute.domain}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 sm:p-6 md:p-8">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    <div className="flex items-start">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm sm:text-base text-gray-900 font-medium break-words">{institute.contactEmail || 'Not provided'}</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm sm:text-base text-gray-900 font-medium">{institute.contactPhone || 'Not provided'}</p>
                      </div>
                    </div>
                    <div className="flex items-start sm:col-span-2">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm sm:text-base text-gray-900 font-medium">{institute.address || 'Not provided'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {institute.description && (
                    <div className="mb-6 sm:mb-8">
                      ...
                      <p className="text-sm sm:text-base text-gray-600">{institute.description}</p>
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                    <div className="bg-blue-50 p-4 sm:p-6 rounded-lg sm:rounded-xl border border-blue-200">
                      ...
                      <p className="text-xl sm:text-2xl font-bold text-blue-900">{institute.stats?.totalUsers || 0}</p>
                      <p className="text-xs sm:text-sm text-blue-600">Total Users</p>
                    </div>
                    <div className="bg-purple-50 p-4 sm:p-6 rounded-lg sm:rounded-xl border border-purple-200">
                      ...
                      <p className="text-xl sm:text-2xl font-bold text-purple-900">{institute.stats?.totalCourses || 0}</p>
                      <p className="text-xs sm:text-sm text-purple-600">Total Courses</p>
                    </div>
                    <div className="bg-orange-50 p-4 sm:p-6 rounded-lg sm:rounded-xl border border-orange-200">
                      ...
                      <p className="text-xl sm:text-2xl font-bold text-orange-900">{institute.stats?.totalDepartments || 0}</p>
                      <p className="text-xs sm:text-sm text-orange-600">Departments</p>
                    </div>
                  </div>
                </div>
              </div>
