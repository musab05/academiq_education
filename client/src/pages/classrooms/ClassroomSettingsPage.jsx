          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 space-y-4 sm:space-y-6">
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                />
                <label htmlFor="isPrivate" className="text-xs sm:text-sm font-medium text-gray-700">
            ...
            {currentUser?.role !== 'student' && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mt-4 sm:mt-6">
                <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Danger Zone</h2>
                <div className="border border-red-200 rounded-lg p-3 sm:p-4">
                  <h3 className="font-semibold text-red-600 mb-2 text-sm sm:text-base">Delete Classroom</h3>
                  <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">
                    Once you delete a classroom, there is no going back. All sessions and data will be permanently deleted.
                  </p>
