...
const NotificationsSettingsPage = () => {
  ...
  const [settings, setSettings] = useState({ emailNotifications: true, pushNotifications: false, weeklyDigest: true });
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 p-4 sm:p-6">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Notification Settings</h1>
            <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 space-y-4 sm:space-y-6">
              {[
                { key: 'emailNotifications', title: 'Email Notifications', desc: 'Send email updates to students' },
                { key: 'pushNotifications', title: 'Push Notifications', desc: 'Send push notifications' },
                { key: 'weeklyDigest', title: 'Weekly Digest', desc: 'Send weekly summary emails' }
              ].map(item => (
