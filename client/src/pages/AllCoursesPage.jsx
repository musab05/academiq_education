...
const AllCoursesPage = () => {
  ...
  const handleFiltersChange = (newFilters) => {
    console.log('AllCoursesPage - handleFiltersChange called with:', newFilters);
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex flex-1">
          <div className="main-scroll flex-1 overflow-y-auto" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            ...
            <Courses filters={filters} onClearFilters={handleClearFilters} />
          </div>
          <div className="filter-scroll w-80 overflow-y-auto bg-white shadow-lg mt-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            {user?.role === 'student' ? <RightFilters onFiltersChange={handleFiltersChange} resetTrigger={resetTrigger} /> : <AdminRightSidebar />}
          </div>
        </div>
      </div>
    </div>
