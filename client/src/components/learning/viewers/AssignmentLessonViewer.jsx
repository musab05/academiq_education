    ...
    >
      <div className="mb-8">
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
          ...
          <span className="flex items-center gap-1">
            ...
            Due:{" "}
            {lessonData?.dueDate
              ? new Date(lessonData.dueDate).toLocaleDateString()
              : "No due date"}
          </span>
          <span className="flex items-center gap-1">
      ...
      <div
        className={`border rounded-lg p-4 mb-8 ${
          assignmentProgress?.isCompleted
          ...
          <div>
            ...
            >
              ...
              {assignmentProgress?.submittedAt &&
                ` • ${new Date(assignmentProgress.submittedAt).toLocaleDateString()}`}
            </p>
            {assignmentProgress?.submittedFile && (
              <p className="text-sm text-gray-600 mt-1">
                Files: {assignmentProgress.submittedFile}
              </p>
            )}
            {assignmentProgress?.marks !== undefined &&
              assignmentProgress?.marks !== null && (
                <div className="mt-2">
                  <p className="text-sm font-semibold text-gray-700">
                    Grade: {assignmentProgress.marks}/
                    {lessonData?.maxPoints || 100}
                  </p>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div>
              {lessonData?.instructions ||
                "Assignment instructions will be loaded here."}
            </div>
