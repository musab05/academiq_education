...
const ScormLessonViewer = ({
  ...
  const initializeScorm = async () => {
    try {
      ...
      if (sessionData.data?.cmiData) {
        Object.entries(sessionData.data.cmiData).forEach(([key, value]) => {
          try {
            ...
            if (key.startsWith("cmi.core.")) {
              ...
              if (field === "lesson_status")
                scorm12.cmi.core.lesson_status = value;
              else if (field === "score.raw")
                scorm12.cmi.core.score.raw = value;
              else if (field === "score.min")
                scorm12.cmi.core.score.min = value;
              else if (field === "score.max")
                scorm12.cmi.core.score.max = value;
              else if (field === "lesson_location")
                scorm12.cmi.core.lesson_location = value;
              else if (field === "total_time")
                scorm12.cmi.core.total_time = value;
              else if (field === "session_time")
                scorm12.cmi.core.session_time = value;
              ...
              if (field === "completion_status")
                scorm2004.cmi.completion_status = value;
              else if (field === "success_status")
                scorm2004.cmi.success_status = value;
                ...
                scorm2004.cmi.score.scaled = value;
              else if (field === "progress_measure")
                scorm2004.cmi.progress_measure = value;
            }
          } catch (e) {
        ...
        updateLocalProgress({
          cmi: scorm12.cmi.core?.lesson_status ? scorm12.cmi : scorm2004.cmi,
        });
      }
      ...
      scorm12.LMSSetValue = (element, value) => {
        ...
        progressAPI
          .setScormCMIValue(lesson._id, element, value)
          .then(() => {
            if (
      ...
      scorm12.LMSCommit = () => {
        ...
        const savePromises = [
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.core.lesson_status",
            scorm12.cmi.core.lesson_status,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.core.score.raw",
            scorm12.cmi.core.score.raw,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.core.score.min",
            scorm12.cmi.core.score.min,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.core.score.max",
            scorm12.cmi.core.score.max,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.core.lesson_location",
            scorm12.cmi.core.lesson_location,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.suspend_data",
            scorm12.cmi.suspend_data,
          ),
        ];
      ...
      scorm2004.Commit = () => {
        ...
        const savePromises = [
          progressAPI.setScormCMIValue(
            ...
            scorm2004.cmi.completion_status,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.success_status",
            scorm2004.cmi.success_status,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.location",
            scorm2004.cmi.location,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.score.raw",
            scorm2004.cmi.score.raw,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.score.scaled",
            scorm2004.cmi.score.scaled,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.progress_measure",
            scorm2004.cmi.progress_measure,
          ),
          progressAPI.setScormCMIValue(
            lesson._id,
            "cmi.suspend_data",
            scorm2004.cmi.suspend_data,
          ),
        ];
  ...
  const handleIframeLoad = async () => {
    ...
    try {
      ...
      const progressResponse = await progressAPI.getScormLessonProgress(
        lesson._id,
      );
      ...
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <p className="text-gray-500">
            This lesson doesn't have SCORM content available
          </p>
        </div>
      </div>
    );
